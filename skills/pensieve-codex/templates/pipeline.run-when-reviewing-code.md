...
**Knowledge reference**: `.codex/pensieve/knowledge/taste-review/content.md`
...
2. `.codex/pensieve/knowledge/taste-review/content.md`
...
## Execution Rules（用于 loop）

1. 任务严格按顺序：Task 1 -> Task 2 -> Task 3 -> Task 4
2. 默认保持 1:1 映射；不要合并/跳过
3. 缺上下文就在当前任务内补齐，不要新增额外阶段
